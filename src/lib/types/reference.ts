...
export namespace Reference {
  ...
  export type Reference =
    | Reference_BusyPeople
    | Reference_Moro
    | Reference_OneillNames
    | Reference_Uint;

  export function check(value: unknown): value is Reference {
    return isSum(value) && isTypeFromTagged(value, CHECKERS);
  }

  export function isMoroVariant(
    value: Reference
  ): value is Reference_Moro {
    return value.tag === "Moro";
  }

  export function isOneillVariant(
    value: Reference
  ): value is Reference_OneillNames {
    return value.tag === "OneillNames";
  }

  export function isBusyPeopleVariant(
    value: Reference
  ): value is Reference_BusyPeople {
    return value.tag === "BusyPeople";
  }

  export function isUintVariant(
    value: Reference
  ): value is Reference_Uint {

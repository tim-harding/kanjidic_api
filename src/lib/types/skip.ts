...
export namespace Skip {
  ...
  type SkipTag = HorizontalTag | VerticalTag | EnclosureTag | SolidTag;
  ...
  export function check(value: unknown): value is Skip {
    return isSum(value) && isTypeFromTagged(value, CHECKERS);
  }

  export function serialize(skip: Skip): string {
